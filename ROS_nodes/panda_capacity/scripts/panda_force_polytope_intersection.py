...
def plot_polytope(q1,q2, scaling_factor = 500):
    ...
    start = time.time()
    force_vertex, force_polytopes = panda.force_polytope_intersection(q1,q2)
...
def panda_polytope_intersection():
    global joint_positions1
    global joint_positions2
    rospy.init_node('panda_polytope_intersection')
